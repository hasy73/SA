...
<div class="container">
  ...
  <div class="content">
    ...
    <form name="form2" method="post" action="">
      <p align="center">請選擇欲訂票電影項目:</p>
      <div align="center">
        <table width="300" border="1">
          <tr>
            <td><div align="center"> 片名:</div></td>
            <td><label for="select"></label>
              <div align="center">
                <select name="select" id="select">
                  <option value="1">黑魔女</option>
                </select>
            </div></td>
          </tr>
          <tr>
            <td><div align="center">票種:</div></td>
            <td><div align="center">
          ...
          <tr>
            <td><div align="center">場次:</div></td>
            <td><div align="center">
              <label for="select4"></label>
              <select name="select4" id="select4">
                <option value="1">早場</option>
              </select>
            </div></td>
          </tr>
        </table>
      ...
      <table>
        <tr>
          <td width="106"><div align="center">
            <input type="submit" name="button4" id="button4" value="確認訂票">
          </div></td>
          <td width="106"><div align="center">
            <input type="button" name="button6" id="button6" value="取消訂票">
          </div></td>
        </tr>
      </table>
    </div>
