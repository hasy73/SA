...
String MM_valUsername=request.getParameter("id");
if (MM_valUsername != null) {
  String MM_fldUserAuthorization="";
  String MM_redirectLoginSuccess="hot.jsp";
  ...
  MM_statementUser.setObject(2, request.getParameter("password"));
    ...
    <form ACTION="<%=MM_LoginAction%>" name="form1" method="POST">
      <div align="center">
        ...
        <p>
          ...
          <label for="user or mem"></label>
        </p>
        <table width="250">
          <tr>
            <td width="64" height="38"><div align="center">帳號:</div></td>
            <td width="174"><label for="id3"></label>
              <div align="left">
                <input type="text" name="id" id="id3">
            </div></td>
          </tr>
          <tr>
            <td height="36"><div align="center">密碼:</div></td>
        ...
        <table width="250">
          <tr align="center">
            <td><input type="submit" name="button" id="button" value="登入" ></td>
            <td><input type="reset" name="button2" id="button2" value="清除"></td>
            <td><input type="button" name="button3" id="button3" value="加入會員" action="add.jsp"></td>
          </tr>
        </table>
        <p>&nbsp;</p>
      </div>
