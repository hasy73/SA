...
<div class="container">
  ...
  <div class="content">
    <ul id="MenuBar1" style="margin-left:50px" class="MenuBarHorizontal">
      <li>
        <div align="center"><a class="MenuBarItemSubmenu">電影管理</a>
          <ul>
            <li><a href="7.1.1.1.jsp">新增電影</a></li>
            <li><a href="7.1.1.2.jsp">刪除電影</a></li>
          </ul>
        </div>
      </li>
      <li>
        <div align="center"><a class="MenuBarItemSubmenu">會員管理</a>
          <ul>
            <li><a href="7.1.2.1.jsp">刪除會員</a></li>
            <li><a href="7.1.2.2.jsp">修改會員規章</a></li>
          </ul>
        </div>
      </li>
    </ul>
