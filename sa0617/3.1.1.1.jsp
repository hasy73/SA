...
<div class="container">
  ...
  <div class="content">
    ...
    <div>
      ...
      <p>&nbsp;</p>
      <h1 align="left">修改資料</h1>
      <table class="myTableadd" width="314">
        <tr>
          <td class="td" width="103">姓名:</td>
          <td width="195" align="center" valign="middle" class="td"><div align="left"></div></td>
          </tr>
        <tr>
          <td class="td">新密碼:</td>
          <td align="center" valign="middle" class="td"><div align="left"></div></td>
        </tr>
        <tr>
          <td class="td">地址:</td>
          <td align="center" valign="middle" class="td"><div align="left"></div></td>
          ...
          <table>
            <tr>
              <td width="106"><div align="center">
                <input type="submit" name="button4" id="button4" value="確認修改">
              </div></td>
              <td width="106"><div align="center">
                <input type="reset" name="button5" id="button5" value="返回修改頁面">
              </div></td>
            </tr>
          </table>
        </div>
